...
<head>
    ...
    <title>Exam Project - Admin</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{('/exam_project/')}}">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Exam Project</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{URL::to('/admin/all-product')}}">All Product</a>
                        <a class="collapse-item" href="{{URL::to('/admin/add-product')}}">Add Product</a>
                    </div>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <p class="text-center mb-2"><strong>Exam ProjectPro</strong> is packed with premium features, components, and more!</p>
