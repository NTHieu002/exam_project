                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{ route('login.post') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="email" id="email_address" class="form-control form-control-user" name="email" aria-describedby="emailHelp" placeholder="Enter Email Address..." required autofocus>
                                            @if ($errors->has('email'))
                                        ...
                                        <div class="form-group">
                                            <!-- <div class="custom-control custom-checkbox small">
                                                <label>
                                                    <input class="custom-control-input" type="checkbox" name="remember"> Remember Me
                                                </label>
                                            </div> -->
                                            <div class="custom-control custom-checkbox small">
