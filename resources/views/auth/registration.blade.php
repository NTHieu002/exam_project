                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="{{ route('register.post') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <input type="text" id="name" class="form-control form-control-user" name="name" placeholder="Name" required autofocus>
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group row">
                                    <input type="text" id="email_address" class="form-control form-control-user" name="email" placeholder="Email Address" required autofocus>
                                    @if ($errors->has('email'))
